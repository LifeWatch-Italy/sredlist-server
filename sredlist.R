...
Prom<-future({
  ...
  scientific_name <- sRL_decode(scientific_name)
  Storage_SP=sRL_StoreRead(scientific_name, MANDAT=1) ; print(names(Storage_SP))
  distSP=Storage_SP$distSP_saved; print("Diagnose 1") ; print(nrow(distSP)) ; print(st_area(distSP))
  ...
  print("Diagnose 2") ; print(nrow(distSP)) ; print(st_area(distSP))
  rangeSP_clean<-create_spp_info_data(distSP,
                                      ...
                                      crs=st_crs(CRSMOLL))
  print("Diagnose 3") ; print(nrow(rangeSP_clean)) ; print(st_area(rangeSP_clean)) ; print(names(rangeSP_clean))
