...
if(grepl("Forest_cover", outlog$Value[outlog$Parameter=="Usage_RS"])){
  png::readPNG(paste0("resources/AOH_stored/", sub(" ", "_", scientific_name), "/Plots/RS_plot_forest.png")) %>% grid::rasterGrob() %>% gridExtra::grid.arrange()
...
if(grepl("Human_modification", outlog$Value[outlog$Parameter=="Usage_RS"])){
  png::readPNG(paste0("resources/AOH_stored/", sub(" ", "_", scientific_name), "/Plots/RS_plot_modif.png")) %>% grid::rasterGrob() %>% gridExtra::grid.arrange()
...
if(grepl("Human_density", outlog$Value[outlog$Parameter=="Usage_RS"])){
  png::readPNG(paste0("resources/AOH_stored/", sub(" ", "_", scientific_name), "/Plots/RS_plot_humandensity.png")) %>% grid::rasterGrob() %>% gridExtra::grid.arrange()
