...
`r if("aoo_points" %in% names(Storage_SP)){tryCatch({knitr::knit_child("sRL_markdown_scripts/RMD_child_Step4occ.rmd")}, error=function(e){"!! Error in reporting step 4 !!"})}`
...
`r if("Fragmentation_Isolation" %in% outlog$Parameter){tryCatch({knitr::knit_child("sRL_markdown_scripts/RMD_child_Step6.rmd")}, error=function(e){"!! Error in reporting step 6 !!"})} else {NO_STEP}`
<br><br><br>


## Step 7: Trends in remote-sensing products
`r if("Usage_RS" %in% outlog$Parameter){tryCatch({knitr::knit_child("sRL_markdown_scripts/RMD_child_Step7.rmd")}, error=function(e){"!! Error in reporting step 7 !!"})} else {NO_STEP}`
<br><br><br>


## Step 8: Summary and assign categories
`r tryCatch({knitr::knit_child("sRL_markdown_scripts/RMD_child_Step8.rmd")}, error=function(e){"!! Error in reporting step 8 !!"})`
