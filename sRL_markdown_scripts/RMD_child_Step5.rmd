...
`r if("Compare_GL" %in% outlog$Parameter){"The generation length of related species was extracted: "}`

<center>
![](`r if("Compare_GL" %in% outlog$Parameter){paste0(outDir, '/Plots/ComparisonPlot.png')}`){width=100%}
</center>
...
<br>
<center>
![](`r paste0(outDir, '/Plots/trends_aoh.png')`){width=70%}
</center>
