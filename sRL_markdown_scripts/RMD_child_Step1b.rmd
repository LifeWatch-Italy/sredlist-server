...
`r paste0("You kept only occurrence records with basis of records: ", outlog$Value[outlog$Parameter=="Gbif_BasisOfRecord"] %>% sub("bor_human", "Human observation", .) %>% sub("bor_preserved", "Preserved specimen", .) %>% sub("bor_fossil", "Fossil specimen", .) %>% sub("bor_machine", "Machine observation", .) %>% sub("bor_living", "Living specimen", .) %>% sub("bor_other", "Other", .), ".")` 
