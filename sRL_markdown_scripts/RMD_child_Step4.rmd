...
<center>
![](`r if("Gbif_Extract_Habitat" %in% outlog$Parameter){paste0(outDir, '/Plots/gbifHabExtract.png')}`){width=100%}
</center>
...
<center>
  ![](`r paste0(outDir, '/Plots/aoh.png')`){width=70%}
</center>
...
<br>
  <center>
  ![](`r paste0(outDir, '/Plots/aoo.png')`){width=70%}
</center>
